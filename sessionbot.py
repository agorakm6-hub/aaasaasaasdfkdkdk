# sessionbot.py
import os, asyncio, time, requests, json, datetime, re, threading, sys, logging
...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8895080427:AAE02i4cD0NeWVOShOC6btza4PMitpJxgk8")
...
def set_webhook():
    webhook_url = os.environ.get("WEBHOOK_URL", "https://telegram-bot-374u.onrender.com/webhook")
