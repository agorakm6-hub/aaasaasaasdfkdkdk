...
async function callFreeLLM(prompt, attempt = 1) {
    ...
    try {
        ...
        throw new Error('Не получилось связаться с нейросетью (сервис ApiFreeLLM недоступен или перегружен). Попробуй ещё раз через минуту.');
    } finally {
