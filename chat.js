...
// URL мини-приложения (Bot API 9.4, web_app-кнопка на /start). Прототип
// интерфейса лежит в miniapp/index.html — задеплой его отдельно (например,
// как статику на том же Render) и укажи итоговый https-адрес сюда через
// переменную окружения MINI_APP_URL. Мини-апп ОБЯЗАТЕЛЬНО должен открываться
// по https — иначе Telegram не даст его запустить.
