...
const CODE_FOLLOWUP_TRIGGERS = [
    'добавь функци', 'добавь ещё', 'добавь в код', 'добавь в файл',
    'измени код', 'измени файл', 'поменяй код', 'поменяй файл',
    'перепиши код', 'перепиши файл', 'доработай код', 'доработай файл',
    'исправь код', 'исправь файл', 'обнови код', 'обнови файл',
    'переименуй файл', 'переименуй в', 'смени имя файла', 'поменяй имя файла',
    'убери из кода', 'удали из кода', 'убери функцию', 'удали функцию',
];
...
bot.on('message', async (msg) => {
    ...
    // --- Запрос на генерацию кода (в том числе доработку уже присланного) ---
