...
bot.onText(/\/start/, (msg) => {
    ...
    const text = `👋 Привет, ${name}! Я <b>melonAI</b> — бот на бесплатной безлимитной нейросети.\n\n` +
        `⚠️ <b>Важно про безопасность:</b> в мини-приложении MelonAI я <u>никогда</u> не спрашиваю номер телефона, код из SMS, пароли или данные карты. Если мини-апп под видом MelonAI просит что-то из этого — закрывай его, это мошенничество, не я.\n\n` +
    ...
    bot.sendMessage(
        chatId,
        '🍉 MelonAI теперь доступен в виде мини-приложения — там удобнее переписываться, есть история чатов, голос и режимы моделей.\n\n⚠️ Напоминание: настоящий MelonAI никогда не запрашивает номер телефона, SMS-код, пароли или данные карты. Если это делает мини-апп с похожим названием — это не мы, закрой его.',
        {
            reply_markup: {
                inline_keyboard: [[
                    {
